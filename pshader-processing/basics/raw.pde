//i struggling because the default cam and setup
//not sure if i should choose a middle way mixing some processing some jogl stuff
...
void draw() {
  ...
  gl.glBindBuffer(GL.GL_ELEMENT_ARRAY_BUFFER, vboHandles[0]);
  gl.glBufferData(GL.GL_ELEMENT_ARRAY_BUFFER, indx_buf.capacity() * Short.BYTES, indx_buf, GL3.GL_STATIC_DRAW);
  indx_buf = null;*/
